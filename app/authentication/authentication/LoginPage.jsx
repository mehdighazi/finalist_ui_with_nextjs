...
const LoginPage = () => {
    ...
    const loginHandler = async () => {
        try {
            ...
            dispatch(showAlert({
                message: 'اطلاعات ارسالی نادرست است',
                type: 'error'
            }));
            setLoginStart(false)
        }
    ...
    return (
        ...
        >
            <Box sx={{ p: 1, borderRadius: 3, maxWidth: 250, width: "100%" }}>
                ...
                >
                    <Link href="/about" underline="hover">درباره ما</Link>
                    <Link href="/faq" underline="hover">سوالات متداول</Link>
                    <Link href="/other/contact" underline="hover">تماس با ما</Link>
                    <Link href="/other/terms" underline="hover">قوانین</Link>
