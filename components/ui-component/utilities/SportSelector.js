...
const SportSelector = ({ onChange }) => {
    ...
    const listItemOnclickHandler = (field_id, title) => {
        ...
        if (fieldParentId === 0) {
            setSelectedSport({
                sport_parent_id: field_id,
                sport_parent_title: title,
                sport_field_id: null,
                sport_select_title: null
            })
            ...
            const updatedSport = {
                ...selectedSport,
                sport_field_id: field_id,
                sport_select_title: title
            };
            setSelectedSport(updatedSport);
            onChange(updatedSport);
