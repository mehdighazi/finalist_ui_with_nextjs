...
const CustomBox = styled(Box)(({theme}) => ({
    ...
    paddingLeft: "0%", minHeight: "150px", alignItems: "center", justifyContent: "center",
...
const TeamBox = ({title, logo, color, rating,logoSize}) => {
    return (<>
        <Box sx={{
            align: 'center',
            ...
            <Stack sx={{
                ...
                <Avatar size={logoSize??'sm'} src={logo}/>
...
const SelectTeamCard = (props) => {
    ...
    const rateHost = 0;
   // const logoHost = `${hostAddress}/${props.userTeam.logo["logo_path"]}`;
